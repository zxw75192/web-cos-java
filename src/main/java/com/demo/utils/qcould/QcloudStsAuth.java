...
import com.demo.utils.qcould.module.Sts;
import org.apache.commons.codec.digest.DigestUtils;
import org.apache.commons.codec.digest.HmacUtils;
import com.demo.utils.qcould.Sign;
...
//        config.put("DefaultRegion", "ap-beijing");
        ...
        appId = bucketName.substring(bucketName.indexOf("-")+1);
        name = bucketName.substring(0, bucketName.indexOf("-"));
    }
...
//            Integer time = data.getInt("expiredTime");
